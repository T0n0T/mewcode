...
name: mew-spec
description: >-
  Use when starting any new feature, function, module, configuration change, or
  section-level task — before writing implementation code. Triggers when someone
  says "let's just start coding", "this is too simple for docs", or when the
  project lacks spec.md / plan.md / task.md / checklist.md for the current
  work item.
---
